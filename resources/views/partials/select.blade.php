...
@endisset
    ...
    <select @isset($disabled) {{ "disabled" }} @endisset  class="form-control form-control-alternative   @isset($classselect) {{$classselect}} @endisset"  name="@isset($var_name){{ $var_name }}@else{{ $id }}@endif" id="{{  $id }}">
