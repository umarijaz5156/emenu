            ...
            <div class="card-header border-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-4 text-center">
                        <a href = "{{route('pricing')}}" class="btn btn-primary">See all Plans</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <p>{{ __('You are currently using the ').$planAttribute['plan']['name']." ".__('plan') }}<p>
                <p>{{ __('Need to change your current plan, email or account info please let us know by contacting with us')}}</p>
                <!-- ORDERS -->
