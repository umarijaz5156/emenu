                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Orders') }} ( 30
                                        {{ __('days') }} )</h5>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Sales Volume') }} ( 30
                                        {{ __('days') }} )</h5>
                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">
                                            {{ __('Number of restaurants') }}</h5>
                                        <span class="h2 font-weight-bold mb-0">{{ $countItems }}
                                            {{ __('restaurants') }}</span>
                                    </div>
                                    <div class="col-auto">
                            ...
                            @if ($doWeHaveExpensesApp)
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Expenses') }} ( 30
                                            {{ __('days') }} )</h5>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">{{ $allViews }}
                                        {{ __('views') }}</span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Total Fee') }}
                                                ( 30 {{ __('days') }} )</h5>
