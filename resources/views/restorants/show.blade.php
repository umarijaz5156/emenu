...
@section('extrameta')
    ...
    <meta name="description" content="{{ $restorant->dAescription }}">
@endsection
                            ...
                            @if (!empty($openingTime))
                                ...
                                @endif @if (!empty($closingTime))
                                    ...
                                    @endif | @if (!empty($restorant->address))
                                        <i class="ni ni-pin-3"></i> <a target="_blank"
                                        ...
                                        @if (count($allergens) > 0 && Module::has('allergens'))
                                            <a class='btn btn-neutral btn-small ml-2'
                                                onclick="$('#modalAllergens').modal('show');">{{ __('See all allergens') }}</a>
                                        @endif
                        </p>
                                ...
                                <div class="strip">
                                    ...
                                    @else
                                        <div class="res_mimimum">
                                            ...
                                            @if ($item->happyHoursNow()->count() || $item->category->restorant->getCurrentHappyHoursPercent())
                                                <div
                                                    ...
                                                    <span class="">{{ __('Happy Hours feature') }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    @endif
