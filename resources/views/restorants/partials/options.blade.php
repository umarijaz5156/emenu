@if(!config('settings.makePureSaaS',false)  && !(config('app.isdrive',false)||config('app.issd',false)) )
            @include('partials.fields',['fields'=>[
                ...
                ['ftype'=>'bool','name'=>__("Disable ordering"),'id'=>"disable_ordering",'value'=>$restorant->getConfig('disable_ordering', false) ? "true" : "false"],
            ]])
        ...
        @if (config('app.isqrexact'))
            @include('partials.fields',['fields'=>[
                ...
                ['ftype'=>'bool','additionalInfo'=>__("Enable the option"),'name'=>"Multiple orders in a single ticket",'id'=>"disable_continues_ordering",'value'=>$restorant->getConfig('disable_continues_ordering', 0) ? "false" : "true"],
            ]])
        @endif
@endif
