    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="list-inline ">
                ...
                @endif
                @if($restorant->getConfig('GoogleReview', ''))
                    <li class="list-inline-item">
                        <a href="{{ $restorant->getConfig('GoogleReview', '') }}" target="_blank">
                            <i class="fa fa-globe" style="font-size: 24px;"></i>
                        </a>
                    </li>
                @endif
                 @if($restorant->getConfig('TripAdvisor', ''))
                    <li class="list-inline-item">
                        <a href="{{ $restorant->getConfig('TripAdvisor', '') }}" target="_blank">
                            <i class="fa fa-globe" style="font-size: 24px;"></i>
                        </a>
                    </li>
                @endif
