...
@section('content')
                ...
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-12 col-12 text-right">
                        @if ($hasDemoRestaurants)
                            <a href="{{ route('admin.restaurants.removedemo') }}"
                                class="btn btn-sm btn-danger">{{ __('Remove demo data') }}</a>
                        @endif
                        <a href="{{ route('systemstatus') }}"
                            class="btn btn-sm btn-danger">{{ __('settings_system_status') }}</a>
                        <a href="{{ route('admin.regenerate.sitemap') }}"
                            class="btn btn-sm btn-warning">{{ __('Regenerate sitemap') }}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @endif
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="settings" method="post" action="{{ route('settings.update', $settings->id) }}"
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel"
                                    ...
                                    @if (config('app.isft'))
                                        ...
                                        @include('partials.input', [
                                            'id' => 'mobile_info_title',
                                            'name' => 'Info Title',
                                            'placeholder' => 'Info Title text here ...',
                                            'value' => $settings->mobile_info_title,
                                            'required' => false,
                                        ])
                                        @include('partials.input', [
                                            'id' => 'mobile_info_subtitle',
                                            'name' => 'Info Subtitle',
                                            'placeholder' => 'Info Subtitle text here ...',
                                            'value' => $settings->mobile_info_subtitle,
                                            'required' => false,
                                        ])
                                        <br />
                                        @include('partials.input', [
                                            'id' => 'playstore',
                                            'name' => 'Play Store',
                                            'placeholder' => 'Play Store link here ...',
                                        ...
                                        @include('partials.input', [
                                            'id' => 'appstore',
                                            'name' => 'App Store',
                                            'placeholder' => 'App Store link here ...',
                                ...
                                <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <?php
                                        $images = [['name' => 'site_logo', 'label' => __('Site Logo'), 'value' => config('global.site_logo'), 'style' => 'width: 200px;'], ['name' => 'restorant_details_image', 'help' => '590x400px', 'label' => __('Restaurant Default Image'), 'value' => config('global.restorant_details_image'), 'style' => 'width: 200px;'], ['name' => 'restorant_details_cover_image', 'label' => __('Restaurant Details Cover Image'), 'value' => config('global.restorant_details_cover_image'), 'style' => 'width: 200px;'], ['help' => '256,256px', 'name' => 'favicons', 'label' => __('Favicon'), 'value' => '/apple-touch-icon.png', 'style' => 'width: 120px; height: 120px;']];
                                ...
                                @foreach ($envConfigs as $groupConfig)
                                    <div class="tab-pane fade" id="{{ $groupConfig['slug'] }}" role="tabpanel"
                                                ...
                                                @include('partials.fields', [
                                                    'fields' => [
                                                        [
                                                            ...
                                                            'additionalInfo' =>
                                                                'Please check docs on how to define the custom fields on order.',
                                                            'name' => 'Custom fileds in JSON format',
                                                            'required' => false,
                                                            'placeholder' => '',
                                                            'id' => 'order_fields',
                                                            'ftype' => 'textarea',
                                                            'type' => 'textarea',
                                                            'value' => $settings->order_fields,
                                                        ],
                                                    ],
                                                ])
                                            @endif
