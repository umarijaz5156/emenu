<div class="row">
    <div class="col-md-3">
        @include('partials.input',['class'=>"col-12", 'ftype'=>'input','name'=>"Code(uppercase)",'id'=>"code",'placeholder'=>"",'required'=>false, 'value'=>(isset($coupon))?$coupon->code:''])
    </div>

    <div class="col-md-3">
        @include('partials.input',['class'=>"col-12", 'ftype'=>'input','name'=>"Name",'id'=>"name",'placeholder'=>__("Enter code name"),'required'=>true, 'value'=>isset($coupon)&&$coupon->name?$coupon->name:""])
    </div>
    <div class="col-md-3">
        @if(isset($coupon))
...
<div class="row">
    ...
    <div class="col-md-3">
        @if(isset($coupon))
            @include('partials.input',['class'=>"col-12", 'type'=>'number','name'=>"Limit number",'id'=>"limit_to_num_uses",'placeholder'=>__("Limit number to use"),'required'=>true, 'value'=>$coupon->limit_to_num_uses, 'step'=>1])
        @else
            @include('partials.input',['class'=>"col-12", 'type'=>'number','name'=>"Limit number",'id'=>"limit_to_num_uses",'placeholder'=>__("Limit number to use"),'required'=>true, 'step'=>1])
        @endif
    </div>

    <div class="col-md-3">
        @if(isset($coupon))
            @include('partials.select', ['class'=>"col-12",'name'=>"Coupon Duration",'id'=>"coupon_duration",'placeholder'=>"Select type",'data'=>['forever', 'once'],'required'=>true, 'value'=>$coupon->coupon_duration])
        @else
            @include('partials.select', ['class'=>"col-12",'name'=>"Coupon Duration",'id'=>"coupon_duration",'placeholder'=>"Select type",'data'=>['forever', 'once'],'required'=>true])
        @endif
    </div>
</div>
