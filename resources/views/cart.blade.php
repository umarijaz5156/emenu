            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <form id="order-form" role="form" method="post" action="{{ route('order.store') }}"
                        ...
                        <input type="hidden" id = "totalPriceVal" name = "totalPriceVal">
                        <input type="hidden" id = "variantString" name = "variantString">
                        @csrf
...
@section('js')
    ...
    <script>
        ...
        //     place_order_button.addEventListener('click', change_price);
        // }

        // function change_price() {
        //     const total_price_hidden = document.getElementById('tootalPricewithDeliveryRaw');
        //     if (total_price_hidden) {
        //         total_price_hidden.value = document.getElementById('tootalPricewithDeliveryRaw').value;
        //     }
        // }
    </script>
