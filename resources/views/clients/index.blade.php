                                ...
                                @foreach ($clients as $client)
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{ route('clientss.edit', $client) }}"> {{ $client->name }}</a></td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a href="{{ route('clientss.edit', $client) }}" type="button" class="dropdown-item">
                                                        {{ __('Info') }}
                                                    </a>
                                                    @hasrole('admin')
                                                        <form action="{{ route('clientss.destroy', $client) }}" method="post">
                                                            @csrf
                                                            @method('delete')
