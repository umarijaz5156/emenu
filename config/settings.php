...
return [
    ...
    'vendor_entity_name' => env('VENDOR_ENTITY_NAME', 'Business'),
    'vendor_entity_name_plural' => env('VENDOR_ENTITY_NAME_PLURAL', 'Businesses'),
    'url_route' => env('URL_ROUTE', 'business'),
    'url_route_plural' => env('URL_ROUTE_PLURAL', 'businesses'),
