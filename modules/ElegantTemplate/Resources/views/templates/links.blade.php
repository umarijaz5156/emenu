<div id="hoverlinksdisable" class="w-auto grow py-4 px-0 m-0 font-light text-left  border-b-0 border-t border-gray-200 border-solid border-x-0 text-neutral-700 bg-white"
style = "flex-grow:1">
    <div  class="flex w-100 h-full items-center justify-center"
          style="">
        <div class="p-0 w-100 m-0 text-left  border-0">
            <nav lass="block w-100 p-0 m-0 justify-center"
                 style="overflow: auto hidden; justify-content: start">
...
<style>
    ...
    #hoverlinksdisable a:hover{
        text-decoration: none !important;
    }
    #hoverlinksdisable a:hover::after{
        display: none;
    }

    #hoverlinksdisable .item{
        flex-grow: 1;
        margin: 0 10px;
    }
</style>
