...
class Main extends Provider
{
    ...
    {
        Blade::componentNamespace('Modules\Twilio\View\Components', 'twilio');
    }
    ...
    {
        $langPath = resource_path('lang/modules/twilio');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'twilio');
        } else {
            $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang/en', 'twilio');
        }
    }
