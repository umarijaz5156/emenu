...
class Main extends Provider
{
    ...
    {
        $this->publishes([
            __DIR__ . '/../Config/config.php' => config_path('flutterwave.php'),
        ], 'config');

        $this->mergeConfigFrom(
            __DIR__ . '/../Config/config.php', 'flutterwave'
        );
    }
    ...
    {
        Blade::componentNamespace('Modules\flutterwave\View\Components', 'flutterwave');
    }
    ...
    public function loadTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang/en', 'flutterwave');
        }
    }
