...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name','email', 'password', 'phone', 'api_token', 'birth_date', 'working',  'show_price', 'lat', 'lng', 'numorders', 'rejectedorders','restaurant_id','expotoken',
    ];
    ...
    {
        $ret =  PaymentHistory::where('user_id', $this->id)->get();
        $arr = [];
        foreach ( $ret as $value){
            $arr[] = json_decode($value->payload,true);
        }
        return  $arr;
    }
