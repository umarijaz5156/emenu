...
class LocalOrderRepository extends BaseOrderRepository implements OrderTypeInterface
{
    ...
    public function makeOrder($overridePrice = false){
        ...
        $this->constructOrder($overridePrice);
    ...
    public function makeOrderPre($overridePrice = false)
    {
        if(
            $this->request->delivery_method=="dinein" &&
            !config('settings.disable_continius_ordering') &&
        ...
        //From Parent - Construct the order
        $overridePrice = $this->constructOrderPre($overridePrice);
        $this->clearCart();

        return $overridePrice;
    }

    public function makeOrderTemp($overridePrice = false){
        ...
        //From Parent - Construct the order
        $newOrder = $this->constructOrderTemp($overridePrice);
